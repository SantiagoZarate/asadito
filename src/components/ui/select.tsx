...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'select-menu relative z-50 max-h-96 min-w-[8rem] text-popover-foreground shadow-md *:rounded-md *:border *:bg-popover before:pointer-events-none before:absolute before:aspect-square before:w-[150%] before:-translate-x-[20%] before:backdrop-blur-xs before:[mask-image:radial-gradient(50%_50%,black_70%,transparent_100%)] data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
        position === 'popper' &&
